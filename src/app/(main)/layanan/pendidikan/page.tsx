    ...
    <div className="mt-32">
      <div className="bg-[#F6F8F8] py-20">
        <div className="container mx-auto flex gap-12 bg-[#F6F8F8]">
          <div className="w-[700px] h-[676px] relative">
            <Image
              src="/img/kjp.png"
          ...
          <div className="flex-1 flex flex-col gap-8">
            <div className="flex flex-col gap-2">
              <h3 className="font-bold text-4xl font-plus-jakarta-sans">
            ...
            <div className="font-semibold text-2xl text-pink-500 font-plus-jakarta-sans">
