      ...
      <div className="flex gap-52">
        <div className="flex-1 grid gap-20">
          <div className="flex flex-col justify-center gap-6">
            ...
            <Link
              href="#"
              className="bg-pink-500 text-white text-lg rounded-xl px-20 py-4 w-fit font-semibold"
            >
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                <p className="mt-4">
                  ...
                  H.Nasih,Jalan Mandor Baning,Jalan H.Taiman Timur, Jalan
                  Trikora II.
                </p>
              </div>
              <div>
                ...
                <p className="mt-4">
                  Setu Tipar Desa Mekar Sari, Pilar Batas DKI dengan Provinsi
                  Jawa Barat, PT. Panasonic Desa Tugu/Palsi Gunung,Setu Arman /
                  Desa Rumbut, Kecamatan Cimanggis Kotamadya Depok Provinsi Jawa
                  Barat
                </p>
              </div>
              <div>
