...
*  news photo section with new API format (58a99856)
*  news section with new API format (f4c32187)
*  NavigationBar items icon (258a7b8d)
...
*  New Style, APIs Implementation (f3132a42)
*  Changelog (5ff04152)
...
*  move tentang-jakarta-timur links to navigation-bar.config.ts (21a9a0d9)
...
*  visi misi section on tentang jakarta timur page (38444d03)
